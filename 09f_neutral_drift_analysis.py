...
def main():
    ...
    master_rep3_df_init = master_rep3_df_unique.assign(bin_1=0, bin_2=0, bin_3=0, bin_4=0)
    
    # print(master_rep3_df_unique)
    print(master_rep1_df_init)
    ...
    plt.gca().text(-0.01, 0.01, 0.5, textstr, transform=plt.gca().transAxes, fontsize=10, verticalalignment='top')
    ax.spines['top'].set_visible(False)
    ax.spines['right'].set_visible(False)
    out_name = out_dir + f'library_scores_{expt_id}_f.csv'
