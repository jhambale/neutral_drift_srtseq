...
# outputs are written to ../../minibinders_data/minibinders_outputs directory
...
# Example 1: sh 01c_filter_ngmerge_reads.sh
# ../../minibinders_data/ngs_raw/maa_001/demultiplex/maa_001_demux_metadata.txt
# ../../minibinders_data/ngs_raw/maa_001/demultiplex/*_R1_001.fastq.gz
#
### OUTPUTS
## FastQC
  ...
  pear_out_path=../../minibinders_orthorep_data/minibinders_orthorep_outputs/$experiment_name/merged_reads/${fname%_R[12]_001.fastq*}
	...
	then
	  ...
	  fastp \
        ...
        echo "${fastp_out_path}_out_R1.fastq.gz"
	...
	# cat ${pear_out_path}_out_merged.assembled.fastq | seqkit amplicon -m 4 -P -s -F $flank_f -R $flank_r -r 21:-21 --bed > ${seqkit_filtered_read_variants_out_path}_variants.txt
	...
	cat ${pear_out_path}_out_ngmerged.assembled.fastq | seqkit amplicon -m 4 -P -s -F $flank_f -R $flank_r -r 21:-21 --bed > ${seqkit_filtered_read_variants_out_path}_variants.txt
