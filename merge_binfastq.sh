...
# Example 1: bash merge_binfastq.sh
# ../../minibinders_orthorep_data/ngs_raw/jh_009/demultiplex/jh_009_demux_metadata.txt
# ../../minibinders_orthorep_data/ngs_raw/maa_001/demultiplex/*.fastq.gz
#
### OUTPUTS
## Fastq
## $merged_bin.fastq
